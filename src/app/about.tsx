...
const paragraph2 = `I've recently started as a Software Engineer II at Victra where I am using C#, .NET and React. I'm very excited about this opportunity to continue to grow as a developer. Prior to this, I was a Software Engineer Contractor at Apple. While there, I created new features and added enhancements in a web application used by SREs to manage and monitor the health of their services. This application integrates with many services, which gave me more experience creating APIs and working with data from various sources.`;
